...
+(void)getSDSPlaylistsFromSoundCloud:(soundCloudMediaPickerViewController*)sender
{
    ...
    [SCRequest performMethod:SCRequestMethodGET onResource:[NSURL URLWithString:[NSString stringWithFormat:@"https://api.soundcloud.com/users/silentdiscosquad/tracks?client_id=230ccb26b40f7c87eb65fc03357ffa81"]] usingParameters:nil withAccount:nil sendingProgressHandler:nil responseHandler:^(NSURLResponse *response, NSData *data, NSError *error) {
